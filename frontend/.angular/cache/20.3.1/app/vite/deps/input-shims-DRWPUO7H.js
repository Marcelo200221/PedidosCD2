...
var relocateInput = /* @__PURE__ */ __name((componentEl, inputEl, shouldRelocate, inputRelativeY = 0, disabledClonedInput = false) => {
...
var isFocused = /* @__PURE__ */ __name((input) => {
  return input === input.getRootNode().activeElement;
}, "isFocused");
var addClone = /* @__PURE__ */ __name((componentEl, inputEl, inputRelativeY, disabledClonedInput = false) => {
...
var removeClone = /* @__PURE__ */ __name((componentEl, inputEl) => {
...
var enableHideCaretOnScroll = /* @__PURE__ */ __name((componentEl, inputEl, scrollEl) => {
  if (!scrollEl || !inputEl) {
    return () => {
      return;
    };
  }
  const scrollHideCaret = /* @__PURE__ */ __name((shouldHideCaret) => {
    if (isFocused(inputEl)) {
      relocateInput(componentEl, inputEl, shouldHideCaret);
    }
  }, "scrollHideCaret");
  const onBlur = /* @__PURE__ */ __name(() => relocateInput(componentEl, inputEl, false), "onBlur");
  const hideCaret = /* @__PURE__ */ __name(() => scrollHideCaret(true), "hideCaret");
  const showCaret = /* @__PURE__ */ __name(() => scrollHideCaret(false), "showCaret");
...
var enableInputBlurring = /* @__PURE__ */ __name(() => {
  let focused = true;
  let didScroll = false;
  const doc2 = document;
  ...
  const onFocusin = /* @__PURE__ */ __name(() => {
    focused = true;
  }, "onFocusin");
  const onTouchend = /* @__PURE__ */ __name((ev) => {
    if (didScroll) {
      didScroll = false;
      return;
    }
...
var getScrollData = /* @__PURE__ */ __name((componentEl, contentEl, keyboardHeight, platformHeight) => {
  var _a;
...
var calcScrollData = /* @__PURE__ */ __name((inputRect, contentRect, keyboardHeight, platformHeight) => {
...
var setScrollPadding = /* @__PURE__ */ __name((contentEl, paddingAmount, clearCallback) => {
...
var setClearScrollPaddingListener = /* @__PURE__ */ __name((inputEl, contentEl, doneCallback) => {
  const clearScrollPadding = /* @__PURE__ */ __name(() => {
    if (contentEl) {
...
var enableScrollAssist = /* @__PURE__ */ __name((componentEl, inputEl, contentEl, footerEl, keyboardHeight, enableScrollPadding, keyboardResize, disableClonedInput = false) => {
  ...
  const keyboardShow = /* @__PURE__ */ __name((ev) => {
  ...
  const focusOut = /* @__PURE__ */ __name(() => {
  ...
  const focusIn = /* @__PURE__ */ __name(() => __async(null, null, function* () {
...
var setManualFocus = /* @__PURE__ */ __name((el) => {
  var _a;
...
var jsSetFocus = /* @__PURE__ */ __name((componentEl, inputEl, contentEl, footerEl, keyboardHeight, enableScrollPadding, disableClonedInput = false, platformHeight = 0, waitForResize = true) => __async(null, null, function* () {
  ...
  if (typeof window !== "undefined") {
    ...
    const scrollContent = /* @__PURE__ */ __name(() => __async(null, null, function* () {
    ...
    const doubleKeyboardEventListener = /* @__PURE__ */ __name(() => {
      window.removeEventListener("ionKeyboardDidShow", doubleKeyboardEventListener);
...
var startInputShims = /* @__PURE__ */ __name((config, platform) => __async(null, null, function* () {
  if (doc === void 0) {
    return;
  }
  ...
  const registerInput = /* @__PURE__ */ __name((componentEl) => __async(null, null, function* () {
  ...
  const unregisterInput = /* @__PURE__ */ __name((componentEl) => {
    if (hideCaret) {
...
@ionic/core/components/input-shims.js:
   ...
   *)
*/
//# sourceMappingURL=input-shims-DRWPUO7H.js.map
