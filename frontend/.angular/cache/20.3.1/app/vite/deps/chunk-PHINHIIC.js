...
var reWireGetterSetter = /* @__PURE__ */ __name((instance, hostRef) => {
  var _a2;
...
var getHostRef = /* @__PURE__ */ __name((ref) => {
  if (ref.__stencil__getHostRef) {
    return ref.__stencil__getHostRef();
  }
  return void 0;
}, "getHostRef");
var registerHost = /* @__PURE__ */ __name((hostElement, cmpMeta) => {
  const hostRef = {
    $flags$: 0,
...
var isMemberInElement = /* @__PURE__ */ __name((elm, memberName) => memberName in elm, "isMemberInElement");
var customError;
var consoleError = /* @__PURE__ */ __name((e, el) => (customError || console.error)(e, el), "consoleError");
var STENCIL_DEV_MODE = BUILD.isTesting ? ["STENCIL:"] : [
  "%cstencil",
  "color: white;background:#4c47ff;font-weight: bold; font-size:10px; padding:2px 6px; border-radius: 5px"
];
var consoleDevError = /* @__PURE__ */ __name((...m) => console.error(...STENCIL_DEV_MODE, ...m), "consoleDevError");
var consoleDevWarn = /* @__PURE__ */ __name((...m) => console.warn(...STENCIL_DEV_MODE, ...m), "consoleDevWarn");
var cmpModules = /* @__PURE__ */ new Map();
var loadModule = /* @__PURE__ */ __name((cmpMeta, hostRef, hmrVersionId) => {
...
var needsScopedSSR = /* @__PURE__ */ __name(() => false, "needsScopedSSR");
...
var plt = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: /* @__PURE__ */ __name((h2) => h2(), "jmp"),
  raf: /* @__PURE__ */ __name((h2) => requestAnimationFrame(h2), "raf"),
  ael: /* @__PURE__ */ __name((el, eventName, listener, opts) => el.addEventListener(eventName, listener, opts), "ael"),
  rel: /* @__PURE__ */ __name((el, eventName, listener, opts) => el.removeEventListener(eventName, listener, opts), "rel"),
  ce: /* @__PURE__ */ __name((eventName, opts) => new CustomEvent(eventName, opts), "ce")
};
...
var supportsListenerOptions = (() => {
  ...
  try {
    (_a2 = win.document) == null ? void 0 : _a2.addEventListener(
      "e",
      null,
...
var promiseResolve = /* @__PURE__ */ __name((v) => Promise.resolve(v), "promiseResolve");
...
var queueTask = /* @__PURE__ */ __name((queue, write) => (cb) => {
  queue.push(cb);
  if (!queuePending) {
    queuePending = true;
...
var consume = /* @__PURE__ */ __name((queue) => {
...
var consumeTimeout = /* @__PURE__ */ __name((queue, timeout) => {
  let i2 = 0;
  let ts = 0;
...
var nextTick = /* @__PURE__ */ __name((cb) => promiseResolve().then(cb), "nextTick");
var readTask = queueTask(queueDomReads, false);
var writeTask = queueTask(queueDomWrites, true);
var getAssetPath = /* @__PURE__ */ __name((path) => {
  const assetUrl = new URL(path, plt.$resourcesUrl$);
  return assetUrl.origin !== win.location.origin ? assetUrl.href : assetUrl.pathname;
}, "getAssetPath");
var isDef = /* @__PURE__ */ __name((v) => v != null && v !== void 0, "isDef");
var isComplexType = /* @__PURE__ */ __name((o) => {
  o = typeof o;
...
var RemoteValue = (_a = class {
  ...
  static fromLocalValue(serialized) {
    ...
    switch (type) {
      ...
      case "number":
        ...
        return value;
      case "array":
        return value.map((item) => _a.fromLocalValue(item));
      case "date":
        return new Date(value);
      case "map":
        const map2 = /* @__PURE__ */ new Map();
        for (const [key, val] of value) {
          const deserializedKey = typeof key === "object" && key !== null ? _a.fromLocalValue(key) : key;
          const deserializedValue = _a.fromLocalValue(val);
      ...
      case "set":
        ...
        for (const item of value) {
          set.add(_a.fromLocalValue(item));
        }
        return set;
      case "symbol":
        return Symbol(value);
  ...
  static fromLocalValueArray(serializedValues) {
    return serializedValues.map((value) => _a.fromLocalValue(value));
  }
  /**
...
__export(result_exports, {
  ...
  unwrapErr: /* @__PURE__ */ __name(() => unwrapErr, "unwrapErr")
});
...
__name(map, "map");
var unwrap = /* @__PURE__ */ __name((result) => {
  if (result.isOk) {
    return result.value;
  } else {
    throw result.value;
...
var unwrapErr = /* @__PURE__ */ __name((result) => {
  if (result.isErr) {
    return result.value;
  } else {
    throw result.value;
...
__name(deserializeProperty, "deserializeProperty");
...
var lowerPathParam = /* @__PURE__ */ __name((fn) => (p) => fn(p.toLowerCase()), "lowerPathParam");
...
var updateFallbackSlotVisibility = /* @__PURE__ */ __name((elm) => {
...
var getSlottedChildNodes = /* @__PURE__ */ __name((childNodes) => {
  const result = [];
...
__name(getHostSlotNodes, "getHostSlotNodes");
var getSlotChildSiblings = /* @__PURE__ */ __name((slot, slotName, includeSlot = true) => {
  const childNodes = [];
...
var isNodeLocatedInSlot = /* @__PURE__ */ __name((nodeToRelocate, slotName) => {
...
var addSlotRelocateNode = /* @__PURE__ */ __name((newChild, slotNode, prepend, position) => {
...
var getSlotName = /* @__PURE__ */ __name((node) => typeof node["s-sn"] === "string" ? node["s-sn"] : node.nodeType === 1 && node.getAttribute("slot") || void 0, "getSlotName");
function patchSlotNode(node) {
  if (node.assignedElements || node.assignedNodes || !node["s-sr"]) return;
  const assignedFactory = /* @__PURE__ */ __name((elementsOnly) => (function(opts) {
    const toReturn = [];
    ...
    return toReturn;
  }).bind(node), "assignedFactory");
  node.assignedElements = assignedFactory(true);
  node.assignedNodes = assignedFactory(false);
}
__name(patchSlotNode, "patchSlotNode");
function dispatchSlotChangeEvent(elm) {
  elm.dispatchEvent(new CustomEvent("slotchange", { bubbles: false, cancelable: false, composed: false }));
}
__name(dispatchSlotChangeEvent, "dispatchSlotChangeEvent");
...
__name(findSlotFromSlottedNode, "findSlotFromSlottedNode");
var patchPseudoShadowDom = /* @__PURE__ */ __name((hostElementPrototype) => {
...
var patchCloneNode = /* @__PURE__ */ __name((HostElementPrototype) => {
...
var patchSlotAppendChild = /* @__PURE__ */ __name((HostElementPrototype) => {
...
var patchSlotRemoveChild = /* @__PURE__ */ __name((ElementPrototype) => {
...
var patchSlotPrepend = /* @__PURE__ */ __name((HostElementPrototype) => {
...
var patchSlotAppend = /* @__PURE__ */ __name((HostElementPrototype) => {
...
var patchSlotInsertAdjacentHTML = /* @__PURE__ */ __name((HostElementPrototype) => {
...
var patchSlotInsertAdjacentText = /* @__PURE__ */ __name((HostElementPrototype) => {
  HostElementPrototype.insertAdjacentText = function(position, text) {
    this.insertAdjacentHTML(position, text);
  };
}, "patchSlotInsertAdjacentText");
var patchInsertBefore = /* @__PURE__ */ __name((HostElementPrototype) => {
...
var patchSlotInsertAdjacentElement = /* @__PURE__ */ __name((HostElementPrototype) => {
...
var patchTextContent = /* @__PURE__ */ __name((hostElementPrototype) => {
...
var patchChildSlotNodes = /* @__PURE__ */ __name((elm) => {
  const _FakeNodeList = class _FakeNodeList extends Array {
    item(n) {
      return this[n];
    }
  };
  __name(_FakeNodeList, "FakeNodeList");
  let FakeNodeList = _FakeNodeList;
...
var patchSlottedNode = /* @__PURE__ */ __name((node) => {
...
var patchNextSibling = /* @__PURE__ */ __name((node) => {
...
var patchNextElementSibling = /* @__PURE__ */ __name((element) => {
...
var patchPreviousSibling = /* @__PURE__ */ __name((node) => {
...
var patchPreviousElementSibling = /* @__PURE__ */ __name((element) => {
...
var patchParentNode = /* @__PURE__ */ __name((node) => {
...
__name(patchHostOriginalAccessor, "patchHostOriginalAccessor");
...
__name(internalCall, "internalCall");
var i = 0;
var createTime = /* @__PURE__ */ __name((fnName, tagName = "") => {
...
var uniqueTime = /* @__PURE__ */ __name((key, measureText) => {
  if (BUILD.profile && performance.mark) {
...
var registerStyle = /* @__PURE__ */ __name((scopeId2, cssText, allowCS) => {
...
var attachStyles = /* @__PURE__ */ __name((hostRef) => {
  const cmpMeta = hostRef.$cmpMeta$;
...
var getScopeId = /* @__PURE__ */ __name((cmp, mode) => "sc-" + (BUILD.mode && mode && cmp.$flags$ & 32 ? cmp.$tagName$ + "-" + mode : cmp.$tagName$), "getScopeId");
var convertScopedToShadow = /* @__PURE__ */ __name((css) => css.replace(/\/\*!@([^\/]+)\*\/[^\{]+\{/g, "$1{"), "convertScopedToShadow");
var hydrateScopedToShadow = /* @__PURE__ */ __name(() => {
  if (!win.document) {
    return;
  }
...
var h = /* @__PURE__ */ __name((nodeName, vnodeData, ...children) => {
  let child = null;
  let key = null;
  let slotName = null;
  let simple = false;
...
var newVNode = /* @__PURE__ */ __name((tag, text) => {
  const vnode = {
    $flags$: 0,
    $tag$: tag,
    $text$: text,
...
var Host = {};
var isHost = /* @__PURE__ */ __name((node) => node && node.$tag$ === Host, "isHost");
var vdomFnUtils = {
  forEach: /* @__PURE__ */ __name((children, cb) => children.map(convertToPublic).forEach(cb), "forEach"),
  map: /* @__PURE__ */ __name((children, cb) => children.map(convertToPublic).map(cb).map(convertToPrivate), "map")
};
var convertToPublic = /* @__PURE__ */ __name((node) => ({
  vattrs: node.$attrs$,
...
var convertToPrivate = /* @__PURE__ */ __name((node) => {
...
var validateInputProperties = /* @__PURE__ */ __name((inputElm) => {
...
var initializeClientHydrate = /* @__PURE__ */ __name((hostElm, tagName, hostId, hostRef) => {
  var _a2, _b, _c;
  ...
  vnode.$elm$ = hostElm;
  const members = Object.entries(((_a2 = hostRef.$cmpMeta$) == null ? void 0 : _a2.$members$) || {});
  members.forEach(([memberName, [memberFlags, metaAttributeName]]) => {
    ...
    if (attrVal !== null) {
      const attrPropVal = parsePropertyValue(
        attrVal,
        memberFlags,
        BUILD.formAssociated && !!(((_a22 = hostRef.$cmpMeta$) == null ? void 0 : _a22.$flags$) & 64)
      );
...
var clientHydrate = /* @__PURE__ */ __name((parentVNode, childRenderNodes, slotNodes, shadowRootNodes, hostElm, node, hostId, slottedNodes = []) => {
  let childNodeType;
  let childIdSplt;
  let childVNode;
  let i2;
...
var initializeDocumentHydrate = /* @__PURE__ */ __name((node, orgLocNodes) => {
  if (node.nodeType === 1) {
...
var createSimpleVNode = /* @__PURE__ */ __name((vnode) => {
  const defaultVNode = {
    $flags$: 0,
    $hostId$: null,
    $nodeId$: null,
...
__name(addSlot, "addSlot");
var addSlottedNodes = /* @__PURE__ */ __name((slottedNodes, slotNodeId, slotName, slotNode, hostId) => {
  var _a2, _b;
...
var findCorrespondingNode = /* @__PURE__ */ __name((node, type) => {
  let sibling = node;
  do {
...
var safeSelector = /* @__PURE__ */ __name((selector) => {
  const placeholders = [];
  let index = 0;
...
var restoreSafeSelector = /* @__PURE__ */ __name((placeholders, content) => {
...
var createSupportsRuleRe = /* @__PURE__ */ __name((selector) => {
...
var stripComments = /* @__PURE__ */ __name((input) => {
  return input.replace(_commentRe, "");
}, "stripComments");
var _commentWithHashRe = /\/\*\s*#\s*source(Mapping)?URL=[\s\S]+?\*\//g;
var extractCommentsWithHash = /* @__PURE__ */ __name((input) => {
...
var processRules = /* @__PURE__ */ __name((input, ruleCallback) => {
...
var escapeBlocks = /* @__PURE__ */ __name((input) => {
...
var insertPolyfillHostInCssText = /* @__PURE__ */ __name((cssText) => {
...
var convertColonRule = /* @__PURE__ */ __name((cssText, regExp, partReplacer) => {
...
var colonHostPartReplacer = /* @__PURE__ */ __name((host, part, suffix) => {
  return host + part.replace(_polyfillHost, "") + suffix;
}, "colonHostPartReplacer");
var convertColonHost = /* @__PURE__ */ __name((cssText) => {
  return convertColonRule(cssText, _cssColonHostRe, colonHostPartReplacer);
}, "convertColonHost");
var colonHostContextPartReplacer = /* @__PURE__ */ __name((host, part, suffix) => {
...
var convertColonSlotted = /* @__PURE__ */ __name((cssText, slotScopeId) => {
...
var convertColonHostContext = /* @__PURE__ */ __name((cssText) => {
  return convertColonRule(cssText, _cssColonHostContextRe, colonHostContextPartReplacer);
}, "convertColonHostContext");
var convertShadowDOMSelectors = /* @__PURE__ */ __name((cssText) => {
  return _shadowDOMSelectorsRe.reduce((result, pattern) => result.replace(pattern, " "), cssText);
}, "convertShadowDOMSelectors");
var makeScopeMatcher = /* @__PURE__ */ __name((scopeSelector2) => {
  const lre = /\[/g;
  const rre = /\]/g;
  scopeSelector2 = scopeSelector2.replace(lre, "\\[").replace(rre, "\\]");
  return new RegExp("^(" + scopeSelector2 + ")" + _selectorReSuffix, "m");
}, "makeScopeMatcher");
var selectorNeedsScoping = /* @__PURE__ */ __name((selector, scopeSelector2) => {
  const re = makeScopeMatcher(scopeSelector2);
  return !re.test(selector);
}, "selectorNeedsScoping");
var injectScopingSelector = /* @__PURE__ */ __name((selector, scopingSelector) => {
  return selector.replace(_selectorPartsRe, (_, before = "", _colonGroup, colon = "", after = "") => {
    return before + scopingSelector + colon + after;
  });
}, "injectScopingSelector");
var applySimpleSelectorScope = /* @__PURE__ */ __name((selector, scopeSelector2, hostSelector) => {
...
var applyStrictSelectorScope = /* @__PURE__ */ __name((selector, scopeSelector2, hostSelector) => {
  const isRe = /\[is=([^\]]*)\]/g;
  scopeSelector2 = scopeSelector2.replace(isRe, (_, ...parts) => parts[0]);
  const className = "." + scopeSelector2;
  const _scopeSelectorPart = /* @__PURE__ */ __name((p) => {
    let scopedP = p.trim();
    if (!scopedP) {
      return "";
    }
...
var scopeSelector = /* @__PURE__ */ __name((selector, scopeSelectorText, hostSelector, slotSelector) => {
...
var scopeSelectors = /* @__PURE__ */ __name((cssText, scopeSelectorText, hostSelector, slotSelector, commentOriginalSelector) => {
...
var scopeCssText = /* @__PURE__ */ __name((cssText, scopeId2, hostScopeId, slotScopeId, commentOriginalSelector) => {
...
var replaceShadowCssHost = /* @__PURE__ */ __name((cssText, hostScopeId) => {
  return cssText.replace(/-shadowcsshost-no-combinator/g, `.${hostScopeId}`);
}, "replaceShadowCssHost");
var expandPartSelectors = /* @__PURE__ */ __name((cssText) => {
...
var scopeCss = /* @__PURE__ */ __name((cssText, scopeId2, commentOriginalSelector) => {
  ...
  if (commentOriginalSelector) {
    const processCommentedSelector = /* @__PURE__ */ __name((rule) => {
...
var computeMode = /* @__PURE__ */ __name((elm) => modeResolutionChain.map((h2) => h2(elm)).find((m) => !!m), "computeMode");
var setMode = /* @__PURE__ */ __name((handler) => modeResolutionChain.push(handler), "setMode");
var getMode = /* @__PURE__ */ __name((ref) => {
  var _a2;
  return (_a2 = getHostRef(ref)) == null ? void 0 : _a2.$modeName$;
}, "getMode");
var parsePropertyValue = /* @__PURE__ */ __name((propValue, propType, isFormAssociated) => {
...
var getElement = /* @__PURE__ */ __name((ref) => {
  var _a2;
  return BUILD.lazyLoad ? (_a2 = getHostRef(ref)) == null ? void 0 : _a2.$hostElement$ : ref;
}, "getElement");
var createEvent = /* @__PURE__ */ __name((ref, name, flags) => {
  const elm = getElement(ref);
  return {
    emit: /* @__PURE__ */ __name((detail) => {
...
var emitEvent = /* @__PURE__ */ __name((elm, name, opts) => {
  const ev = plt.ce(name, opts);
  elm.dispatchEvent(ev);
  return ev;
}, "emitEvent");
var setAccessor = /* @__PURE__ */ __name((elm, memberName, oldValue, newValue, isSvg, flags, initialRender) => {
...
var parseClassList = /* @__PURE__ */ __name((value) => {
...
var updateElement = /* @__PURE__ */ __name((oldVnode, newVnode, isSvgMode2, isInitialRender) => {
...
__name(sortedAttrNames, "sortedAttrNames");
var scopeId;
var contentRef;
var hostTagName;
...
var isSvgMode = false;
var createElm = /* @__PURE__ */ __name((oldParentVNode, newParentVNode, childIndex) => {
  var _a2;
...
var relocateToHostRoot = /* @__PURE__ */ __name((parentElm) => {
  plt.$flags$ |= 1;
...
var putBackInOriginalLocation = /* @__PURE__ */ __name((parentElm, recursive) => {
  plt.$flags$ |= 1;
...
var addVnodes = /* @__PURE__ */ __name((parentElm, before, parentVNode, vnodes, startIdx, endIdx) => {
...
var removeVnodes = /* @__PURE__ */ __name((vnodes, startIdx, endIdx) => {
...
var updateChildren = /* @__PURE__ */ __name((parentElm, oldCh, newVNode2, newCh, isInitialRender = false) => {
  let oldStartIdx = 0;
  let newStartIdx = 0;
  let idxInOld = 0;
  let i2 = 0;
...
var isSameVnode = /* @__PURE__ */ __name((leftVNode, rightVNode, isInitialRender = false) => {
...
var referenceNode = /* @__PURE__ */ __name((node) => node && node["s-ol"] || node, "referenceNode");
var patch = /* @__PURE__ */ __name((oldVNode, newVNode2, isInitialRender = false) => {
...
var relocateNodes = [];
var markSlotContentForRelocation = /* @__PURE__ */ __name((elm) => {
  let node;
...
var nullifyVNodeRefs = /* @__PURE__ */ __name((vNode) => {
  if (BUILD.vdomRef) {
    vNode.$attrs$ && vNode.$attrs$.ref && vNode.$attrs$.ref(null);
    vNode.$children$ && vNode.$children$.map(nullifyVNodeRefs);
  }
}, "nullifyVNodeRefs");
var insertBefore = /* @__PURE__ */ __name((parent, newNode, reference) => {
...
__name(addRemoveSlotScopedClass, "addRemoveSlotScopedClass");
var renderVdom = /* @__PURE__ */ __name((hostRef, renderFnResults, isInitialLoad = false) => {
  var _a2, _b, _c, _d, _e;
...
var slotReferenceDebugNode = /* @__PURE__ */ __name((slotVNode) => {
  var _a2;
  return (_a2 = win.document) == null ? void 0 : _a2.createComment(
    `<slot${slotVNode.$name$ ? ' name="' + slotVNode.$name$ + '"' : ""}> (host=${hostTagName.toLowerCase()})`
  );
}, "slotReferenceDebugNode");
var originalLocationDebugNode = /* @__PURE__ */ __name((nodeToRelocate) => {
  var _a2;
  return (_a2 = win.document) == null ? void 0 : _a2.createComment(
    `org-location for ` + (nodeToRelocate.localName ? `<${nodeToRelocate.localName}> (host=${nodeToRelocate["s-hn"]})` : `[${nodeToRelocate.textContent}]`)
  );
}, "originalLocationDebugNode");
var attachToAncestor = /* @__PURE__ */ __name((hostRef, ancestorComponent) => {
...
var scheduleUpdate = /* @__PURE__ */ __name((hostRef, isInitialLoad) => {
  ...
  const dispatch = /* @__PURE__ */ __name(() => dispatchHooks(hostRef, isInitialLoad), "dispatch");
  if (isInitialLoad) {
    queueMicrotask(() => {
      dispatch();
    });
...
var dispatchHooks = /* @__PURE__ */ __name((hostRef, isInitialLoad) => {
  const elm = hostRef.$hostElement$;
...
var enqueue = /* @__PURE__ */ __name((maybePromise, fn) => isPromisey(maybePromise) ? maybePromise.then(fn).catch((err2) => {
  console.error(err2);
  fn();
}) : fn(), "enqueue");
...
var callRender = /* @__PURE__ */ __name((hostRef, instance, elm, isInitialLoad) => {
...
var postUpdateComponent = /* @__PURE__ */ __name((hostRef) => {
...
var forceUpdate = /* @__PURE__ */ __name((ref) => {
  var _a2;
...
var appDidLoad = /* @__PURE__ */ __name((who) => {
  var _a2;
  if (BUILD.asyncQueue) {
    plt.$flags$ |= 2;
  }
...
var safeCall = /* @__PURE__ */ __name((instance, method, arg, elm) => {
...
var emitLifecycleEvent = /* @__PURE__ */ __name((elm, lifecycleName) => {
...
var addHydratedFlag = /* @__PURE__ */ __name((elm) => {
  var _a2, _b;
  return BUILD.hydratedClass ? elm.classList.add((_a2 = BUILD.hydratedSelectorName) != null ? _a2 : "hydrated") : BUILD.hydratedAttribute ? elm.setAttribute((_b = BUILD.hydratedSelectorName) != null ? _b : "hydrated", "") : void 0;
}, "addHydratedFlag");
var serverSideConnected = /* @__PURE__ */ __name((elm) => {
    ...
    FORM_ASSOCIATED_CUSTOM_ELEMENT_CALLBACKS.forEach((cbName) => {
      ...
      Object.defineProperty(prototype, cbName, {
        value(...args) {
          ...
          if (!instance) {
            (_a22 = hostRef == null ? void 0 : hostRef.$onReadyPromise$) == null ? void 0 : _a22.then((asyncInstance) => {
...
More information: https://stenciljs.com/docs/properties#prop-mutability`
            ...
            if (BUILD.lazyLoad) {
              ...
              const setterSetVal = /* @__PURE__ */ __name(() => {
        ...
        Object.defineProperty(prototype, memberName, {
          value(...args) {
            var _a22;
            const ref = getHostRef(this);
            return (_a22 = ref == null ? void 0 : ref.$onInstancePromise$) == null ? void 0 : _a22.then(() => {
              var _a3;
        ...
        /* @__PURE__ */ new Set([
          ...
          ...members.filter(
            ...
            if (BUILD.reflect && m[0] & 512) {
              (_a22 = cmpMeta.$attrsToReflect$) == null ? void 0 : _a22.push([propName, attrName]);
            }
            return attrName;
          })
        ])
...
var initializeComponent = /* @__PURE__ */ __name((elm, hostRef, cmpMeta, hmrVersionId) => __async(null, null, function* () {
  let Cstr;
  ...
  const ancestorComponent = hostRef.$ancestorComponent$;
  const schedule = /* @__PURE__ */ __name(() => scheduleUpdate(hostRef, true), "schedule");
...
var fireConnectedCallback = /* @__PURE__ */ __name((instance, elm) => {
  if (BUILD.lazyLoad) {
    safeCall(instance, "connectedCallback", void 0, elm);
  }
}, "fireConnectedCallback");
var connectedCallback = /* @__PURE__ */ __name((elm) => {
  if ((plt.$flags$ & 1) === 0) {
...
var setContentReference = /* @__PURE__ */ __name((elm) => {
  if (!win.document) {
    return;
  }
...
var disconnectInstance = /* @__PURE__ */ __name((instance, elm) => {
  if (BUILD.lazyLoad) {
    safeCall(instance, "disconnectedCallback", void 0, elm || instance);
  }
}, "disconnectInstance");
var disconnectedCallback = /* @__PURE__ */ __name((elm) => __async(null, null, function* () {
  if ((plt.$flags$ & 1) === 0) {
    const hostRef = getHostRef(elm);
...
var proxyCustomElement = /* @__PURE__ */ __name((Cstr, compactMeta) => {
  const cmpMeta = {
    $flags$: compactMeta[0],
...
var Fragment = /* @__PURE__ */ __name((_, children) => children, "Fragment");
var addHostEventListeners = /* @__PURE__ */ __name((elm, hostRef, listeners, attachParentListeners) => {
...
var hostListenerProxy = /* @__PURE__ */ __name((hostRef, methodName) => (ev) => {
  var _a2;
  try {
    if (BUILD.lazyLoad) {
...
var getHostListenerTarget = /* @__PURE__ */ __name((doc, elm, flags) => {
...
var hostListenerOpts = /* @__PURE__ */ __name((flags) => supportsListenerOptions ? {
  passive: (flags & 1) !== 0,
  capture: (flags & 2) !== 0
} : (flags & 2) !== 0, "hostListenerOpts");
...
@stencil/core/internal/client/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-PHINHIIC.js.map
