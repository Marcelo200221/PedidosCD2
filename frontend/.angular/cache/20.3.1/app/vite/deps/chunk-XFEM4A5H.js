...
var DURATION = 540;
var getClonedElement = /* @__PURE__ */ __name((tagName) => {
  return document.querySelector(`${tagName}.ion-cloned-element`);
}, "getClonedElement");
var shadow = /* @__PURE__ */ __name((el) => {
  return el.shadowRoot || el;
}, "shadow");
var getLargeTitle = /* @__PURE__ */ __name((refEl) => {
...
var getBackButton = /* @__PURE__ */ __name((refEl, backDirection) => {
  const tabs = refEl.tagName === "ION-TABS" ? refEl : refEl.querySelector("ion-tabs");
  let buttonsList = [];
  if (tabs != null) {
    const activeTab = tabs.querySelector("ion-tab:not(.tab-hidden), .ion-page:not(.ion-page-hidden)");
...
var createLargeTitleTransition = /* @__PURE__ */ __name((rootAnimation, rtl, backDirection, enteringEl, leavingEl) => {
...
}, "createLargeTitleTransition");
var animateBackButton = /* @__PURE__ */ __name((rootAnimation, rtl, backDirection, backButtonEl, backButtonBox, backButtonTextEl, backButtonTextBox, largeTitleEl, largeTitleTextBox) => {
  var _a, _b;
...
var animateLargeTitle = /* @__PURE__ */ __name((rootAnimation, rtl, backDirection, largeTitleEl, largeTitleBox, largeTitleTextBox, backButtonBox, backButtonTextEl, backButtonTextBox) => {
  var _a, _b;
...
var iosTransitionAnimation = /* @__PURE__ */ __name((navEl, opts) => {
  var _a;
  try {
...
@ionic/core/components/ios.transition.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XFEM4A5H.js.map
